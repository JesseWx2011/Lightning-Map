...
# -------------------------------
# Step 0: Setup cleanup targets
# -------------------------------
extract_dir = "gtwo_shapefiles"
zip_path = "gtwo_shapefiles.zip"  # optional if you want to save zip locally
...
try:
    ...
    timestamp_str = filename.split("_")[-1].replace(".shp", "")
    try:
    ...
    utc_str = file_dt.strftime("%H:%M UTC")
    ...
    # -------------------------------
    plt.savefig("docs/tropical_maps/tropics_outlook.png", dpi=100, bbox_inches='tight')
    plt.show()
    ...
    if os.path.exists(extract_dir):
        ...
        print(f"Cleaned up folder: {extract_dir}")
